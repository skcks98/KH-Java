...
public class MapService {
	...
	public void ex1() {
		...
		// HashMap<K(key), V(value)> : Map의 자식 클래스 중 가장 대표되는 Map
	...
	public void ex2() {
		...
		Set<String> set = map.keySet(); // id, pw, age 가 저장됨
	...
	public void ex3() { // List안에 Map 넣는거 자주 사용함!!
		...
		for(int i=0; i< 10; i++) {
			...
			// Map에 데이터 추가
			map.put("id", "user0" + i); // user00 ~ user09
			map.put("pw", "pass0" + i); // user00 ~ user09
		...
		for( Map<String, Object> temp : list ) {
			...
			System.out.println(temp.get("id")); // id 대응 값 모두 출력
		}
