...
public class ClsService /* extends Student */ {
	...
	public void ex2() {
		...
		// ** static 이 붙은 필드(변수) '클래스명.변수명' 으로 사용함 **
	...
	public void ex3() {
		...
		// 해결방법 1 : setter를 이용해 새로운 값 대입
		
		u2.setUserId("asd1234");
		u2.setUserPw("pasd222");		
		u2.setUserName("김영희");		
		u2.setUserAge(25);		
		u2.setUserGender('여');		
	...
	public void ex4() {
		...
		User u3 = new User("user03","pass03","김길동", 25 ,'남'); 
		// 매개변수 5개 생성자(필드 전부 초기화 목적)
