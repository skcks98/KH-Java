...
public class Member {
	...
	public String getMemberId() {
		// 반환형 : String 자료형을 나(이 메서드)를 호출할 쪽으로 돌려보내겠다.
		
		return memberId;
		// return memberId : 이 메서드를 호출한 쪽으로 memberId에 저장된 값을 돌려보낸다.
		// 매개변수가 없어서 중복된 이름의 memberId가 없기 때문에 memberId라고만 꺼도 가능
	}



	// setter : 세팅하는 애 , 무엇을 세팅할지 전달받아온 것이 매개변수
