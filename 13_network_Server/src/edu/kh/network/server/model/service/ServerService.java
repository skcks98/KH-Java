...
public class ServerService {
	 ...
	 * 
	 *  * java.net 패키지에서 제공하는
	 *  Socket, ServerSocker 클래스를 사용해야함.
	 *  
	 *  Socket
	 *  - 프로세스 양 끝단(프로세스간의 통신을 담당)
	 ...
	 *   
	 * 	- 하나의 포트에는 하나의 ServerSocket만 연결 간으
	 * 
	 * 
	 * */
	...
	public void ServerStart() {
		...
		try {
			...
			clientSocket = serverSocket.accept(); // 서버 요청 수락
			...
			// new Date() 로 객체 생성 시 현재 시간이 now에 저장이 된다.
			...
			pw.flush(); // flush() : 스트림 내용을 밀어냄 **중요!! 시험에 나옴**
			//pw 이용해서 출력하면 println이 있어야함
			...
			System.out.println("클라이언트에게 전달할 메시지 : ");
